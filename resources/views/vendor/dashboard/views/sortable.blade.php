...
<div class="container">
  ...
  chosenClass: 'active'
        ...
        <ul class="list-group" id="demo1">
          <li class="list-group-item"><a class="handle btn btn-default" href="#"><i class="fas fa-sort"></i></a> Cras justo odio</li>
          <li class="list-group-item"><a class="handle btn btn-default" href="#"><i class="fas fa-sort"></i></a> Dapibus ac facilisis in</li>
          <li class="list-group-item"><a class="handle btn btn-default" href="#"><i class="fas fa-sort"></i></a> Morbi leo risus</li>
          <li class="list-group-item"><a class="handle btn btn-default" href="#"><i class="fas fa-sort"></i></a> Porta ac consectetur ac</li>
          <li class="list-group-item"><a class="handle btn btn-default" href="#"><i class="fas fa-sort"></i></a> Vestibulum at eros</li>
        </ul>
